...
let btn9 = $g('#btn9');
let btn10 = $g('#btn10');
let QALsit = $g('.QA-List').querySelector('.col-8');
...
btn7.onclick = function () {
    ...
    cloneContent.querySelector("#flush-collapseTwo").querySelector("p").innerText = "如您訂購一個月以後的場地，則可享有平台保障7天內免費取消的權益，若超過7天以上欲取消場地，則依照場地主訂定的取消金比例計算。<br>注意：取消金額與取消日相關，如欲取消建議您盡早取消以降低取消金。<br>如您訂購一個月以內的場地，如付款後欲取消，則依場地主訂定的取消比例計算之。<br>場地主的取消比例皆按照距離活動日的天數收取不同比例的手續費，而每間場地的退款規定皆不相同，(詳細內容請參考場地頁中的取消條款說明)</p";
    QALsit.append(cloneContent);
}
