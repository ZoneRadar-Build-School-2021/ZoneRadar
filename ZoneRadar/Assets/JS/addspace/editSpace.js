...
if (compare.includes(Newdatalist) && datlist.length==7)
{
    if (datlist[0].OperatingDay==1) {
        ...
        if (datlist[0].StartTime.Hours == 6 && datlist[0].EndTime.Hours == 23) {
            ...
            let hour = datlist[0].StartTime.Hours;
            let ShourString = hour.toString();

            let hourE = datlist[0].EndTime.Hours;
            let EhourString = hourE.toString();
